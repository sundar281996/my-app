...
export default function App() {
    ...
    <div className="App">
      ...
      {peoples.map((people)=>(
        <Msg name={people.name} pic={people.pic}/>)
      )}
...
function Press(){
  ...
  return(
    <div>
      ...
      <button className="btn1" onClick={()=>setDislike(dislike+1)}>👎 {dislike} </button>
